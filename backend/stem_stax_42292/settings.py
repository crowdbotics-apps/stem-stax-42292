"""
Django settings for stem_stax_42292 project.
...
ROOT_URLCONF = 'stem_stax_42292.urls'
...
WSGI_APPLICATION = 'stem_stax_42292.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stem_stax_42292 API",
    "DESCRIPTION": "API documentation for stem_stax_42292 App",
    "VERSION": "v1",
}
